...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2023 a las 15:30:54
...
--
CREATE DATABASE IF NOT EXISTS `db_votaciones` DEFAULT CHARACTER SET utf32 COLLATE utf32_spanish2_ci;
USE `db_votaciones`;
...
CREATE TABLE `tbl_candidatos` (
  ...
  `nombre_candidato` varchar(60) NOT NULL,
...
INSERT INTO `tbl_candidatos` (`id_candidato`, `nombre_candidato`, `created_at`, `updated_at`) VALUES
(1, 'JOSE VASQUEZ', '2023-08-01 03:32:13', '2023-08-01 03:32:13'),
(2, 'JUAN PEREZ', '2023-08-01 03:32:13', '2023-08-01 03:32:13'),
(3, 'MARIA DOMINGUEZ', '2023-08-01 03:32:13', '2023-08-01 03:32:13'),
(4, 'LUCIA RUIZ', '2023-08-01 03:32:13', '2023-08-01 03:32:13'),
(5, 'JOSÉ MARTÍNEZ', '2023-08-01 03:32:13', '2023-08-01 03:32:13'),
(6, 'WILLIAM JARAMILLO', '2023-08-01 03:32:13', '2023-08-01 03:32:13');
...
INSERT INTO `tbl_comunas` (`id_comuna`, `comuna`, `id_provincia`) VALUES
(1, 'Arica', 1),
(2, 'Camarones', 1),
(3, 'General Lagos', 2),
(4, 'Putre', 2),
...
CREATE TABLE `tbl_contactos` (
  ...
  `descr_contacto` varchar(20) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish2_ci;
...
INSERT INTO `tbl_contactos` (`id_contacto`, `descr_contacto`, `created_at`, `updated_at`) VALUES
(1, 'Web', '2023-08-01 01:27:21', '2023-08-01 01:27:21'),
(2, 'TV', '2023-08-01 01:27:21', '2023-08-01 01:27:21'),
(3, 'Redes Sociales', '2023-08-01 01:27:21', '2023-08-01 01:27:21'),
(4, 'Amigo', '2023-08-01 01:27:21', '2023-08-01 01:27:21'),
(5, 'Periódico', '2023-08-01 13:09:32', '2023-08-01 13:09:32');
...
INSERT INTO `tbl_provincias` (`id_provincia`, `provincia`, `id_region`) VALUES
(1, 'Arica', 1),
(2, 'Parinacota', 1),
(3, 'Iquique', 2),
(4, 'El Tamarugal', 2),
...
INSERT INTO `tbl_regiones` (`id_region`, `region`, `abreviatura`, `capital`) VALUES
...
--
-- Estructura de tabla para la tabla `tbl_registro_contactos`
--

CREATE TABLE `tbl_registro_contactos` (
  `id_reg_contacto` int(11) NOT NULL,
...
CREATE TABLE `tbl_votos` (
  ...
  `rut` varchar(15) NOT NULL,
  `name_lastname` varchar(60) NOT NULL,
...
ALTER TABLE `tbl_candidatos`
  ...
  ADD UNIQUE KEY `nombre_candidato` (`nombre_candidato`);
...
ALTER TABLE `tbl_contactos`
  ...
  ADD UNIQUE KEY `descr_contacto` (`descr_contacto`);
...
--
-- Indices de la tabla `tbl_registro_contactos`
--
ALTER TABLE `tbl_registro_contactos`
  ADD PRIMARY KEY (`id_reg_contacto`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_registro_contactos`
--
ALTER TABLE `tbl_registro_contactos`
  MODIFY `id_reg_contacto` int(11) NOT NULL AUTO_INCREMENT;
